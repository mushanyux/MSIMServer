...
// Route 路由配置
func (cn *Common) Route(r *mshttp.MSHttp) {
	...
	r.GET("/v1/health", func(c *mshttp.Context) {
		var (
...
// 获取后台运行引导视频
func (cn *Common) getKeepAliveVideo(c *mshttp.Context) {
...
// 获取pc最新版本
func (cn *Common) getPCNewVersion(c *mshttp.Context) {
	os := c.Param("os")
	tempOS := ""
...
func (cn *Common) updater(c *mshttp.Context) {
	os := c.Param("os")
...
// 查询app模块
func (cn *Common) appModule(c *mshttp.Context) {
...
// 查询聊天背景列表
func (cn *Common) chatBgList(c *mshttp.Context) {
...
func (cn *Common) appConfig(c *mshttp.Context) {
...
func (cn *Common) countriesList(c *mshttp.Context) {
	c.JSON(http.StatusOK, Countrys())
}

// 添加app版本
func (cn *Common) addAppVersion(c *mshttp.Context) {
...
// 获取最新版本
func (cn *Common) getNewVersion(c *mshttp.Context) {
	os := c.Param("os")
...
// 查询总记录
func (cn *Common) appVersionList(c *mshttp.Context) {
	err := c.CheckLoginRole()
	if err != nil {
		c.ResponseError(err)
		return
